    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <section className="mb-8">
        ...
        <div className="text-center">
          <p className="mb-4">
            Welcome to <span className="text-blue-500">cvsCode</span>! Below are the steps to get started:
          </p>
        </div>
      </section>
      ...
      <section className="mb-8 inline-block shadow-md rounded-lg p-4">
        <h2 className="text-lg font-semibold mb-2">Navigating to REPL Directory</h2>
        <p className="text-gray-600 dark:text-gray-300">
          Once installed, navigate to the directory where you&apos;ve installed the cvsCode REPL.
        </p>
      </section>
      ...
      <section className="mb-8 inline-block shadow-md rounded-lg p-4">
        <h2 className="text-lg font-semibold mb-2">Getting Started with CVSCode</h2>
        <p className="text-gray-600 dark:text-gray-300">
